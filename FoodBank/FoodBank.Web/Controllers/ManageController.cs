...
{
    [Authorize]
    public class ManageController : BaseFoodController
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;
        private AppDbContext _appDbContext;

        public ManageController(IAppDbContext AppDbContext)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var user = _appDbContext.Users.FirstOrDefault(o => o.Id == userId);
            if (user != null)
            {
        ...
        public async Task<ActionResult> Index(IndexViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                if (model.AvatarUpload != null)
                    user.AvatarUrl = await new ImageStorage().StoreAvatar(model.AvatarUpload, user.Id);
